...
import TopBar from '../components/perspectives/as/TopBar'
import Main from '../components/perspectives/as/Main'
...
import { rootUrl, layoutConfig } from '../configs/as/GeneralConfig'
...
const mapStateToProps = state => {
  ...
  return {
    ...
    times: state.times,
    titles: state.titles,
    titlesFacets: state.titlesFacets,
